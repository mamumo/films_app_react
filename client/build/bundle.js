...
/***/ function(module, exports, __webpack_require__) {
	...
	var OpeningsBox = __webpack_require__(163);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(OpeningsBox, null), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var FilmsList = __webpack_require__(164);
	var sampleData = [{ id: 1, title: "Gone with the wind" }, { id: 2, title: "James Bond Jnr" }];
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'a',
	          { href: 'http://www.imdb.com/calendar/?region=gb&pf_rd_m=A2FGELUUNOQJNL&pf_rd_p=1970868962&pf_rd_r=0WJMJP2CHGKS36522G0X&pf_rd_s=right-2&pf_rd_t=15061&pf_rd_i=homepage&ref_=hm_otw_hd' },
	          'UK Openings This Week'
	        )
	      ),
	      React.createElement(FilmsList, { data: this.state.data })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Film = __webpack_require__(165);
	var FilmsList = React.createClass({
	  ...
	  render: function render() {
	    var filmNodes = this.props.data.map(function (film) {
	      return React.createElement(
	        Film,
	        { title: film.title, id: film.id, key: film.id },
	        film.text
	      );
	    }.bind(this));
